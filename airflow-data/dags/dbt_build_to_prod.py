...
DBT_PROJECT_PATH = '/home/vinicius/Área de trabalho/dev/Lighthouse/adventure_works_dbt'
...
dbt_deps = BashOperator(
    task_id='dbt_deps',
    bash_command="""
    cd /home/vinicius/Área\\ de\\ trabalho/dev/Lighthouse/adventure_works_dbt && \
    /home/vinicius/Área\\ de\\ trabalho/dev/Lighthouse/adventure_works_airflow/airflow-venv/bin/dbt deps --debug
    """,
    env=dbt_env,
    dag=dag,
)
...
dbt_run = BashOperator(
    ...
    bash_command="""
    cd /home/vinicius/Área\\ de\\ trabalho/dev/Lighthouse/adventure_works_dbt && \
    /home/vinicius/Área\\ de\\ trabalho/dev/Lighthouse/adventure_works_airflow/airflow-venv/bin/dbt run --target prod --debug
    """,
    env=dbt_env,
    dag=dag,
)
...
dbt_test = BashOperator(
    ...
    bash_command="""
    cd /home/vinicius/Área\\ de\\ trabalho/dev/Lighthouse/adventure_works_dbt && \
    /home/vinicius/Área\\ de\\ trabalho/dev/Lighthouse/adventure_works_airflow/airflow-venv/bin/dbt test --target prod --debug
    """,
    env=dbt_env,
    dag=dag,
)
